...
export { omcToolsServer, omcToolNames, getOmcToolNames } from './mcp/omg-tools-server.js';
...
export { install, isInstalled, getInstallInfo, isClaudeInstalled, GROK_CONFIG_DIR as INSTALLER_CLAUDE_CONFIG_DIR, AGENTS_DIR, COMMANDS_DIR, VERSION as INSTALLER_VERSION, type InstallResult, type InstallOptions } from './installer/index.js';
/**
 ...
 * @example
 * ```typescript
 * import { createOmcSession } from 'oh-my-grok';
 * import { query } from '../shims/claude-agent-sdk.js';
 *
...
export { getPluginRoot, getPluginDataDir, getConfigDir, mapModel, MODEL_MAP, TOOL_MAP, mapToolName, } from "./adapters/grok/index.js";
export { atomicWriteFileSync, atomicWriteJsonSync, atomicWriteJsonSync as atomicWriteJson, } from "./lib/atomic-write.js";
export { resolveStateDir, modePath, readMode, writeMode, listActiveModes, type ModeState, } from "./lib/mode-state.js";
export { parseAgentSpec, hasTmux, resolveAgentBin, planTeam, readTeamState, shutdownTeam, teamStatePath, type TeamSpec, type TeamState, type AgentKind, } from "./team/plan.js";
