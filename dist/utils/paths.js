...
/**
 * Get the plugin cache base directory for oh-my-grok.
 * This is the directory containing version subdirectories.
 *
 * Structure: <configDir>/plugins/cache/omg/oh-my-grok/
 */
export function getPluginCacheBase() {
    return join(getClaudeConfigDir(), 'plugins', 'cache', 'omg', 'oh-my-grok');
}
/**
 ...
 * are still referenced by long-running sessions via GROK_PLUGIN_ROOT. */
    ...
    for (const marketplace of marketplaces) {
        ...
        for (const pluginName of pluginNames) {
            ...
            for (const version of versions) {
                ...
                // running session whose GROK_PLUGIN_ROOT still points to this path working.
