...
function selectAgentType(component) {
    const roleToAgent = {
        frontend: 'oh-my-grok:designer',
        backend: 'oh-my-grok:executor',
        database: 'oh-my-grok:executor',
        api: 'oh-my-grok:executor',
        ui: 'oh-my-grok:designer',
        shared: 'oh-my-grok:executor',
        testing: 'oh-my-grok:qa-tester',
        docs: 'oh-my-grok:writer',
        config: 'oh-my-grok:executor',
        module: 'oh-my-grok:executor'
    };
    return roleToAgent[component.role] || 'oh-my-grok:executor';
}
