...
export declare const REPO_NAME = "oh-my-grok";
export declare const GITHUB_API_URL = "https://api.github.com/repos/Yeachan-Heo/oh-my-grok";
export declare const GITHUB_RAW_URL = "https://raw.githubusercontent.com/Yeachan-Heo/oh-my-grok";
