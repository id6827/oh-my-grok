 ...
 * Config gate: agents.sharedMemory.enabled in ~/.grok/.omg-config.json
 *
 * @see https://github.com/anthropics/oh-my-grok/issues/1119
 */
import { z } from 'zod';
...
// Helpers
// ---------------------------------------------------------------------------
const DISABLED_MSG = `Shared memory is disabled. Set agents.sharedMemory.enabled = true in ${getClaudeConfigDir()}/.omg-config.json to enable.`;
