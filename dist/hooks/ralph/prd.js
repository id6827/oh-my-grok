...
export function writePrd(directory, prd, sessionId) {
    ...
    if (sessionId) {
        ...
        // prefer writing to an existing legacy location, or .omg by default.
...
5. If ALL stories are done, run \`/oh-my-grok:cancel\` to cleanly exit ralph mode and clean up all state files
