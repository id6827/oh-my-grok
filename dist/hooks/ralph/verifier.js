 ...
 * 4. If architect approves -> truly complete, use /oh-my-grok:cancel to exit
...
3. **Based on ${criticLabel}'s response:**
   - If APPROVED: Output the exact correlated approval tag \`${approvalTag}\`, then run \`/oh-my-grok:cancel\` to cleanly exit
...
4. After ${criticLabel} approves, run \`/oh-my-grok:cancel\` to cleanly exit
