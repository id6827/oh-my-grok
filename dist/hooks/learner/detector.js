...
Would you like me to extract this as a learned skill? Type \`/oh-my-grok:skillify\` to save it (\`/oh-my-grok:learner\` remains as a deprecated compatibility alias), or continue with your current task.
`.trim();
}
