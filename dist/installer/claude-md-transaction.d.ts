...
export declare const CLAUDE_MD_IMPORT_START = "<!-- OMG:IMPORT:START -->";
export declare const CLAUDE_MD_IMPORT_END = "<!-- OMG:IMPORT:END -->";
export declare const CLAUDE_MD_IMPORT_BLOCK = "<!-- OMG:IMPORT:START -->\n@CLAUDE-omg.md\n<!-- OMG:IMPORT:END -->\n";
