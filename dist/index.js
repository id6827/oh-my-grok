...
import { omcToolsServer, getOmcToolNames } from './mcp/omg-tools-server.js';
...
REPO_OWNER, REPO_NAME, GITHUB_API_URL, GROK_CONFIG_DIR, VERSION_FILE, 
...
// Installer exports
export { install, isInstalled, getInstallInfo, isClaudeInstalled, GROK_CONFIG_DIR as INSTALLER_CLAUDE_CONFIG_DIR, AGENTS_DIR, COMMANDS_DIR, VERSION as INSTALLER_VERSION } from './installer/index.js';
/**
...
// --- OMG host adapters & lightweight runtime helpers (Grok Build surface) ---
...
export { resolveStateDir, modePath, readMode, writeMode, listActiveModes, } from "./lib/mode-state.js";
export { parseAgentSpec, hasTmux, resolveAgentBin, planTeam, readTeamState, shutdownTeam, teamStatePath, } from "./team/plan.js";
