 ...
 *
 * This example demonstrates advanced features of Oh-My-Grok:
...
async function main() {
  console.log('=== Advanced Oh-My-Grok Example ===\n');
...
`,
    config: {
      agents: {
        omg: { model: 'claude-opus-4-6-20260205' }
      },
      features: {
