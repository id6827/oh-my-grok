...
This compatibility command keeps `/oh-my-grok:project-session-manager` available without loading the full `project-session-manager` skill description in every Grok Build session.
