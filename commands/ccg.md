...
This compatibility command keeps `/oh-my-grok:ccg` available without loading the full `ccg` skill description in every Grok Build session.

## Dispatch

1. Read the full bundled skill instructions from the active OMG plugin/install: `skills/ccg/SKILL.md`.
