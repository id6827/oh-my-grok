...
This compatibility command keeps `/oh-my-grok:trace` available without loading the full `trace` skill description in every Grok Build session.

## Dispatch

1. Read the full bundled skill instructions from the active OMG plugin/install: `skills/trace/SKILL.md`.
