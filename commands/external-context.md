...
This compatibility command keeps `/oh-my-grok:external-context` available without loading the full `external-context` skill description in every Grok Build session.
