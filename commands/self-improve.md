...
This compatibility command keeps `/oh-my-grok:self-improve` available without loading the full `self-improve` skill description in every Grok Build session.
