...
This compatibility command keeps `/oh-my-grok:ask` available without loading the full `ask` skill description in every Grok Build session.

## Dispatch

1. Read the full bundled skill instructions from the active OMG plugin/install: `skills/ask/SKILL.md`.
