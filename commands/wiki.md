...
This compatibility command keeps `/oh-my-grok:wiki` available without loading the full `wiki` skill description in every Grok Build session.

## Dispatch

1. Read the full bundled skill instructions from the active OMG plugin/install: `skills/wiki/SKILL.md`.
