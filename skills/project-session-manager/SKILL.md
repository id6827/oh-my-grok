...
Automate isolated development environments using git worktrees and tmux sessions with Grok Build. Enables parallel work across multiple tasks, projects, and repositories.
...
The **public session ID** (colon form, e.g. `omg:pr-123`) is the human-facing
...
8. **Launch Grok Build** (unless --no-claude):
   ```bash
