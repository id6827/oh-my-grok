...
- **Blocked primary URL (403/timeout/challenge HTML):** do not invent content. Try an alternate official URL, archive, or ask the user to paste the source; do not claim to bypass login/WAF.
