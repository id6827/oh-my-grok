...
Use this skill when the current session uncovered a repeatable workflow that should become a reusable OMG skill.
...
4. When drafting a learned skill file, output a complete skill file that starts with YAML frontmatter.
   ...
   - Write learned/user/project skills to flat file-backed paths:
     - `${GROK_CONFIG_DIR:-~/.claude}/skills/omg-learned/<skill-name>.md`
