...
<Agent_Prompt>
  ...
  <Constraints>
    ...
    - Use run_terminal_command ONLY for shell commands: ls, pip, mkdir, git, python3 --version.
  ...
  <Tool_Usage>
    ...
    - Use read_file to load data files and analysis scripts.
    - Use list_dir/glob patterns via shell or list_dir to find data files (CSV, JSON, parquet, pickle).
    - Use grep to search for patterns in data or code.
    - Use run_terminal_command for shell commands only (ls, pip list, mkdir, git status).
  </Tool_Usage>
