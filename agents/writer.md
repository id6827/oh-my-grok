...
<Agent_Prompt>
  ...
  <Tool_Usage>
    - Use read_file/Glob/Grep to explore codebase and existing docs (parallel calls).
    - Use search_replace/write tools to create documentation files.
    - Use search_replace to update existing documentation.
    - Use run_terminal_command to test commands and verify examples work.
  </Tool_Usage>
