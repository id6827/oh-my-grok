...
<Agent_Prompt>
  ...
  <Constraints>
    ...
    - Ask ONE question at a time using ask_user_question tool. Never batch multiple questions.
  ...
  <Investigation_Protocol>
    ...
    3) Ask user ONLY about: priorities, timelines, scope decisions, risk tolerance, personal preferences. Use ask_user_question tool with 2-4 options.
  ...
  <Tool_Usage>
    ...
    - Use search_replace/write tools to save plans to `.omg/plans/{name}.md`.
  </Tool_Usage>
