...
```
/oh-my-grok:pipeline review
```

Or demonstrate custom pipeline:
```
/oh-my-grok:pipeline explore:haiku -> architect:opus -> critic:opus -> executor:sonnet
```
...
```
/oh-my-grok:pipeline explore:haiku -> architect:opus -> executor-high:opus -> qa-tester:sonnet
```
