...
**Duration:** 2 minutes
**Objective:** Demonstrate interactive planning with ask_user_question UI for requirement gathering
...
**What happens:**
- ask_user_question UI appears with clickable options
...
2. **ask_user_question UI** - Clickable options, not typing long responses
