...
This directory contains demo scripts for showcasing Oh-My-Grok's capabilities.
...
### Required Setup
- OMG installed and configured (`/oh-my-grok:omg-setup` completed)
- HUD statusline installed (`/oh-my-grok:hud setup`)
...
which omg || echo "Run: /oh-my-grok:omg-setup"
...
- [ ] No active OMG operations running (`/oh-my-grok:cancel --all`)
...
### Opening (1 min)
"Today I'll show you Oh-My-Grok - a multi-agent orchestration system that transforms Claude from a single assistant into a coordinated team of specialists. Instead of doing everything yourself, you conduct a symphony of AI agents, each optimized for specific tasks."
...
### Closing (1 min)
"OMG transforms how you work with Claude - from manual coding to orchestrating specialized agents. All open source at github.com/Yeachan-Heo/oh-my-grok."
...
- **State cleanup**: Between demos, verify clean state with `/oh-my-grok:cancel`
...
**Solution**: Jump to next phase or use `/oh-my-grok:cancel` and show fallback
