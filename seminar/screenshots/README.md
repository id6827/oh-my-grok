...
**Description:** Split-screen comparison showing manual Grok Build usage on left vs. OMG orchestrated on right, demonstrating the difference in workflow.
...
```
┌─────────────────────────────────────┬─────────────────────────────────────┐
│ BEFORE: Manual Grok Build          │ AFTER: OMG Orchestration            │
├─────────────────────────────────────┼─────────────────────────────────────┤
...
**Capture Instructions:**
1. Ensure HUD is installed: `claude` then `/oh-my-grok:hud setup`
...
1. Use a pipeline preset or custom pipeline:
   ```
   /oh-my-grok:pipeline review "analyze the authentication system"
   ```
...
**Description:** Interactive planning session using ask_user_question tool with clickable options.
...
1. Start planning with vague request:
   ...
   ```
2. Capture the ask_user_question UI when it appears
...
1. Start swarm mode:
   ```
   /oh-my-grok:swarm 5:executor "implement all CRUD operations"
   ```
