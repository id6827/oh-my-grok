...
# oh-my-grok Quick Reference Card
**v3.6.3 | github.com/Yeachan-Heo/oh-my-grok**
...
| Command | Purpose |
|---------|---------|
| `/oh-my-grok:omg-setup` | Initial setup wizard |
| `/oh-my-grok:hud setup` | Enable HUD statusline |
| `/oh-my-grok:omg-doctor` | Diagnose issues |
| `/oh-my-grok:omg-help` | Show usage guide |
| `/oh-my-grok:cancel` | Stop current operation |
| `/oh-my-grok:note` | Save compaction-resilient note |
| `/oh-my-grok:learner` | Extract reusable skill |
| `/oh-my-grok:analyze` | Deep analysis/debugging |
| `/oh-my-grok:deepsearch` | Thorough codebase search |
| `/oh-my-grok:ultraqa` | QA cycling (test/fix/repeat) |
| `/oh-my-grok:tdd` | Test-driven development mode |
...
- **Website:** yeachan-heo.github.io/oh-my-grok-website
- **NPM:** `npm i -g oh-my-grok`
