...
---
# oh-my-grok: Multi-Agent Orchestration for Grok Build
...
Note: This is a 60-minute seminar covering the complete oh-my-grok system. We'll focus on practical usage patterns.
...
Note: These are real problems I faced building production applications with Grok Build. OMG was born from frustration with manually orchestrating AI-assisted development.
...
**A multi-agent orchestration system for Grok Build**
...
Note: OMG transforms Claude from a single performer into a conductor of an orchestra of specialized AI agents.
...
/oh-my-grok:autopilot Add OAuth2 authentication
...
Note: The model parameter is always passed explicitly - Grok Build doesn't auto-apply model from agent definitions.
...
Note: The HUD integrates with Grok Build's statusLine API to show real-time orchestration state.
...
```bash
git clone https://github.com/Yeachan-Heo/oh-my-grok.git
cd oh-my-grok
...
**GitHub Repository**
```
github.com/Yeachan-Heo/oh-my-grok
```

**Website & Documentation**
```
yeachan-heo.github.io/oh-my-grok-website
```
...
**Getting Help**
```
/oh-my-grok:omg-help    - Usage guide
/oh-my-grok:omg-doctor  - Diagnose issues
```
...
| Question | Answer |
|----------|--------|
| Does OMG work with Claude API keys? | Yes, both Max/Pro subscription and API keys work |
| Can I use OMG with other AI models? | No, OMG is specifically for Grok Build |
| How do I stop a runaway autopilot? | Say "stop", "cancel", or `/oh-my-grok:cancel` |
| Why is my HUD not showing? | Run `/oh-my-grok:hud setup` |
...
|----------|--------------|--------|
| `autopilot:` | `/oh-my-grok:autopilot` | Full autonomous mode |
| `ralph:` | `/oh-my-grok:ralph` | Persistence mode |
| `ulw` | `/oh-my-grok:ultrawork` | Parallel execution |
| `eco:` | `/oh-my-grok:` | Token-efficient mode |
| `plan` | `/oh-my-grok:plan` | Planning interview |
