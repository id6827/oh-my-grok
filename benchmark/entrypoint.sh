...
echo "Grok Build version: $(claude --version 2>/dev/null || echo 'not installed')"

# Configure Grok Build if auth token is provided
...
if [ "$RUN_MODE" = "omg" ]; then
    echo "Installing oh-my-grok for enhanced mode..."
