...
```bash
/path/to/geobench/dist/geobench estimate --product geobench/oh-my-grok.yaml --providers openai --tier cheap
/path/to/geobench/dist/geobench profile geobench/oh-my-grok.yaml
/path/to/geobench/dist/geobench bench --product geobench/oh-my-grok.yaml --providers openai --tier cheap --mode benchmark
```
