...
Project Session Manager (PSM) automates the creation and management of isolated development environments using git worktrees and tmux sessions with Grok Build. It enables parallel work across multiple tasks, projects, and repositories while maintaining clean separation and easy context switching.
...
1. **Context Switching Overhead**: Switching between tasks requires stashing changes, switching branches, and losing Grok Build context
...
- Spawn pre-configured tmux sessions with Grok Build
...
```bash
# Review PR #123 from oh-my-grok repo
/psm review omg#123
...
4. Launches Grok Build with PR context pre-loaded
...
5. Pre-populates Grok Build with issue description
...
| `--no-claude` | Skip Grok Build launch | false |
...
// ~/.psm/projects.json
{
  "aliases": {
    "omg": {
      "repo": "anthropics/oh-my-grok",
      "local": "~/Workspace/oh-my-grok",
      "default_base": "main"
    },
    "cc": {
...
└─────────────────────────────────────────────────────────────┘
    ...
    ┌─────────────────────────────────────────────────────────┐
    │                    Integration Layer                     │
    │  (gh CLI, git, tmux, claude, omg skills, webhooks)        │
    └─────────────────────────────────────────────────────────┘
```
...
// .psm-session.json
{
  ...
  "source_repo": "~/Workspace/oh-my-grok",
  "github": {
    "pr_number": 123,
    "pr_title": "Add webhook support",
    "pr_author": "contributor",
    "pr_url": "https://github.com/anthropics/oh-my-grok/pull/123"
  },
  "state": "active",
  "notes": []
}
...
🔍 Fetching PR #123 from oh-my-grok...
...
🤖 Launching Grok Build with PR context...
