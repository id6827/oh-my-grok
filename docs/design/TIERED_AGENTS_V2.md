...
| architect-medium | Sonnet | + web_search, web_fetch | Standard analysis, dependency tracing |
...
| Variant | Model | Tools | Focus |
|---------|-------|-------|-------|
| executor-low | Haiku | Read, Glob, Grep, Edit, Write, Bash, todo_write | Single-file, trivial changes |
...
- MUST use todo_write for 2+ step tasks
...
| Variant | Model | Tools | Focus |
|---------|-------|-------|-------|
| document-specialist-low | Haiku | Read, Glob, Grep, web_search, web_fetch | Quick lookups |
...
**ESCALATION RECOMMENDED**: [reason] → Use oh-my-grok:[higher-tier]
</Escalation_Protocol>
```
