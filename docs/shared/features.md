...
**User skill:** `/oh-my-grok:note`
- `/oh-my-grok:note <content>` - Add to Working Memory
- `/oh-my-grok:note --priority <content>` - Add to Priority Context
- `/oh-my-grok:note --manual <content>` - Add to MANUAL section
- `/oh-my-grok:note --show` - Display notepad contents
...
**Important:** Never store OMG state in `~/.grok/` - that directory is reserved for Grok Build itself.
