...
User documentation and technical guides for oh-my-grok.

## Purpose

This directory contains documentation for end-users and developers:

- **End-user guides**: How to use oh-my-grok features
...
[Migration Guide](https://raw.githubusercontent.com/Yeachan-Heo/oh-my-grok/main/docs/MIGRATION.md)
