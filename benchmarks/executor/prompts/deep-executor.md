...
<Agent_Prompt>
  ...
  <Success_Criteria>
    ...
    - All todo_write items completed with verification evidence
  </Success_Criteria>
  ...
  <Investigation_Protocol>
    ...
    5) Create todo_write with atomic steps for multi-step work.
  ...
  <Tool_Usage>
    ...
    <External_Consultation>
      ...
      - Use `spawn_subagent(subagent_type="oh-my-grok:architect", ...)` for architectural cross-checks
