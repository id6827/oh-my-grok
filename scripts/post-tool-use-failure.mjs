...
/**
 * Resolve state file paths for a given omg root and optional session id.
...
// Initialize .omg directory if needed; returns the omg root (not state subdir)
