/**
 * Grok Build project-directory character sanitization (hook-runtime mirror).
 *
 ...
 *
 * Grok Build stores a project's transcripts under
 * `~/.grok/projects/<encoded>`. For normal-length project paths, this helper
 * mirrors Grok Build's character replacement step: every character that is not
 ...
 * This helper intentionally mirrors only Grok Build's normal-length character
