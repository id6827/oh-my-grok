...
Usage:
  ...
  omg ultragoal complete-goals [--retry-failed] [--plan-id <id>] [--json]
...
Multi-plan resolution:
  ...
  ultragoal runs in a shared .omg/ (multi-repo workspaces; see .omg-workspace).
...
Claude /goal integration:
  ...
  while OMG checkpoints G001/G002 stories in the durable ledger.
