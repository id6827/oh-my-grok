...
describe('post-tool-use-failure.mjs', () => {
  ...
  it('uses OMG_SESSION_ID env var as fallback when payload has no session_id', () => {
    const cwd = makeRepoLocalTempDir();
  ...
  it('payload session_id takes priority over OMG_SESSION_ID env var', () => {
    const cwd = makeRepoLocalTempDir();
