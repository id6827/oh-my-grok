...
describe('Keyword Detector', () => {
  ...
  describe('getPrimaryKeyword', () => {
    ...
    it('should not detect ralph in /oh-my-grok:ralph-init', () => {
      const primary = getPrimaryKeyword('/oh-my-grok:ralph-init "my project"');
...
describe('Team staged workflow integration', () => {
  ...
  it('compacts OMG-style root AGENTS guidance on session-start without dropping key sections', async () => {
    const agentsContent = `# oh-my-grok - Intelligent Multi-Agent Orchestration
