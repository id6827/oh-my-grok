...
export interface HudRenderContext {
  ...
  /** Active profile name (derived from GROK_CONFIG_DIR), null if default */
...
export interface HudElementConfig {
  ...
  omcLabel: boolean;
  updateNotification?: boolean; // Show available-update prompt text in the OMG label
  ...
  profile: boolean;            // Show active profile name (from GROK_CONFIG_DIR)
...
export const DEFAULT_HUD_CONFIG: HudConfig = {
  ...
  elements: {
    ...
    hostname: false,
    profile: true,  // Show profile name when GROK_CONFIG_DIR is set
