...
//
// Formats and delivers merge/rebase conflict notifications for omg-teams CLI workers.
//
// NOTE: Markdown inbox is canonical for omg-teams CLI; JSONL is for native /team MCP workers
