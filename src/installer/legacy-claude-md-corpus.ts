...
export const LEGACY_CLAUDE_MD_VARIANTS: readonly LegacyGuideVariant[] = [
  {
    ...
    "openingLine": "# oh-my-grok - Intelligent Multi-Agent Orchestration",
    "finalLine": "For migration guides from earlier versions, see the [Migration Guide](https://raw.githubusercontent.com/Yeachan-Heo/oh-my-grok/main/docs/MIGRATION.md).",
  ...
  },
  {
    ...
    "lineCount": 281,
    "terminalEolPolicy": "required",
    "openingLine": "# OMG Multi-Agent System",
