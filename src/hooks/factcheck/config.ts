...
const DEFAULT_FACTCHECK_POLICY: FactcheckPolicy = {
  ...
  forbidden_path_prefixes: ['${GROK_CONFIG_DIR}/plugins/cache/omg/'],
...
/**
 * Expand ${HOME}, ${WORKSPACE}, and ${GROK_CONFIG_DIR} tokens in a string.
 */
export function expandTokens(value: string, workspace?: string): string {
  ...
  return value
    ...
    .replace(/\$\{GROK_CONFIG_DIR\}/g, getClaudeConfigDir());
}
 ...
 * defaults, and expands ${HOME}/${WORKSPACE}/${GROK_CONFIG_DIR} tokens.
 */
