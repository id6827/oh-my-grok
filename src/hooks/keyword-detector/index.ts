 ...
 * not rerouted into the OMG skill.
 */
...
export interface ExplicitWorkflowSlashInvocation {
  /** Canonical workflow skill name (lowercase, no `oh-my-grok:` prefix). */
 ...
 *
 * Recognizes `/<skill>`, `/omg:<skill>`, and `/oh-my-grok:<skill>` for
...
export function detectKeywordsWithType(
  ...
  // robust to surrounding whitespace, namespace prefixes (`/omg:`,
  // `/oh-my-grok:`), and code-fence/backtick wrapping (handled inside
