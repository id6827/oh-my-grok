...
\`\`\`
Task(
  subagent_type="oh-my-grok:analyst",
  model="opus",
...
Task(subagent_type="oh-my-grok:executor-low", model="haiku", prompt="...")
...
Task(subagent_type="oh-my-grok:executor-high", model="opus", prompt="...")
\`\`\`
...
\`\`\`
Task(
  subagent_type="oh-my-grok:architect-low",
  model="haiku",
...
\`\`\`
Task(
  subagent_type="oh-my-grok:debugger",
  model="sonnet",
...
// Security Review
Task(
  subagent_type="oh-my-grok:security-reviewer",
  model="opus",
...
// Code Quality Review
Task(
  subagent_type="oh-my-grok:code-reviewer",
  model="opus",
