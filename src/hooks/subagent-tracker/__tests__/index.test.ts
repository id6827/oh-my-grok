...
describe("subagent-tracker", () => {
        ...
        agents: [
          {
            ...
            agent_type: "oh-my-grok:executor",
  ...
  describe("getAgentDashboard", () => {
    ...
    it("should show tool count and last tool", () => {
      const state: SubagentTrackingState = {
        agents: [
          {
            agent_id: "test-123",
            agent_type: "oh-my-grok:architect",
            started_at: new Date().toISOString(),
            parent_mode: "none",
            status: "running",
            tool_usage: [
    ...
    it("should strip oh-my-grok: prefix from agent type", () => {
      const state: SubagentTrackingState = {
        agents: [
          {
            agent_id: "test-123",
            agent_type: "oh-my-grok:architect-high",
            started_at: new Date().toISOString(),
            parent_mode: "none",
            status: "running",
          },
      ...
      expect(dashboard).not.toContain("oh-my-grok:architect-high");
    });
  });
  ...
  describe("processSubagentStop", () => {
    ...
    it("reconciles an unmatched fork stop by agent_type when one type matches", () => {
      for (const [id, type] of [
        ["exec-1", "oh-my-grok:executor"],
        ["explore-1", "oh-my-grok:explorer"],
      ] as const) {
        processSubagentStart({
      ...
      processSubagentStop({
        ...
        agent_type: "oh-my-grok:explorer",
    ...
    it("should detect file conflicts between agents", () => {
      const state: SubagentTrackingState = {
        agents: [
          ...
          {
            agent_id: "agent-2",
            agent_type: "oh-my-grok:designer",
            started_at: new Date().toISOString(),
            parent_mode: "ultrawork",
            status: "running",
