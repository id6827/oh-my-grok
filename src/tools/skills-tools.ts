...
export const loadGlobalTool = {
  ...
  description: 'Load and list skills from global user directories (~/.omg/skills/ and [$GROK_CONFIG_DIR|~/.claude]/skills/omg-learned/). Returns skill metadata for all discovered user-scoped skills.',
